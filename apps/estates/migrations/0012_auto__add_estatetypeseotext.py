...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EstateTypeSeoText'
        db.create_table('estates_estatetypeseotext', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type_id', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('estates', ['EstateTypeSeoText'])


    def backwards(self, orm):
        
        # Deleting model 'EstateTypeSeoText'
        db.delete_table('estates_estatetypeseotext')
