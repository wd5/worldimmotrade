...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Apartament.client_number'
        db.add_column('estates_apartament', 'client_number', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Apartament.client_number'
        db.delete_column('estates_apartament', 'client_number')
