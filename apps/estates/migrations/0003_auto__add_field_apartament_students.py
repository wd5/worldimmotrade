...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Apartament.students'
        db.add_column('estates_apartament', 'students', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Apartament.students'
        db.delete_column('estates_apartament', 'students')
    ...
    models = {
        ...
        'estates.apartament': {
            ...
            'students': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
