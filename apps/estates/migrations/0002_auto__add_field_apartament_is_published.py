...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Apartament.is_published'
        db.add_column('estates_apartament', 'is_published', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Apartament.is_published'
        db.delete_column('estates_apartament', 'is_published')
