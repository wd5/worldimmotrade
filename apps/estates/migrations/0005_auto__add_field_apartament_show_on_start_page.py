...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Apartament.show_on_start_page'
        db.add_column('estates_apartament', 'show_on_start_page', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Apartament.show_on_start_page'
        db.delete_column('estates_apartament', 'show_on_start_page')
