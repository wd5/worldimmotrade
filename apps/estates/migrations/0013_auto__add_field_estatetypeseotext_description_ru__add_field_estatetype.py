...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EstateTypeSeoText.description_ru'
        db.add_column('estates_estatetypeseotext', 'description_ru', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'EstateTypeSeoText.description_en'
        db.add_column('estates_estatetypeseotext', 'description_en', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'EstateTypeSeoText.description_de'
        db.add_column('estates_estatetypeseotext', 'description_de', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EstateTypeSeoText.description_ru'
        db.delete_column('estates_estatetypeseotext', 'description_ru')

        # Deleting field 'EstateTypeSeoText.description_en'
        db.delete_column('estates_estatetypeseotext', 'description_en')

        # Deleting field 'EstateTypeSeoText.description_de'
        db.delete_column('estates_estatetypeseotext', 'description_de')
