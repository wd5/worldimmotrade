...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Apartament.living_space_for_m2'
        db.delete_column('estates_apartament', 'living_space_for_m2')

        # Deleting field 'Apartament.total_space_for_m2'
        db.delete_column('estates_apartament', 'total_space_for_m2')

        # Deleting field 'Apartament.land_space_for_m2'
        db.delete_column('estates_apartament', 'land_space_for_m2')

        # Deleting field 'Apartament.price_for_m2'
        db.delete_column('estates_apartament', 'price_for_m2')


    def backwards(self, orm):
        
        # Adding field 'Apartament.living_space_for_m2'
        db.add_column('estates_apartament', 'living_space_for_m2', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Apartament.total_space_for_m2'
        db.add_column('estates_apartament', 'total_space_for_m2', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Apartament.land_space_for_m2'
        db.add_column('estates_apartament', 'land_space_for_m2', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Apartament.price_for_m2'
        db.add_column('estates_apartament', 'price_for_m2', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
