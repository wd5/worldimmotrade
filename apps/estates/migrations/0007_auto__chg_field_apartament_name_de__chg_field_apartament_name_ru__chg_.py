...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Apartament.name_de'
        db.alter_column('estates_apartament', 'name_de', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Apartament.name_ru'
        db.alter_column('estates_apartament', 'name_ru', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Apartament.name'
        db.alter_column('estates_apartament', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Apartament.name_en'
        db.alter_column('estates_apartament', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Apartament.name_de'
        raise RuntimeError("Cannot reverse this migration. 'Apartament.name_de' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Apartament.name_ru'
        raise RuntimeError("Cannot reverse this migration. 'Apartament.name_ru' and its values cannot be restored.")

        # Changing field 'Apartament.name'
        db.alter_column('estates_apartament', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # User chose to not deal with backwards NULL issues for 'Apartament.name_en'
        raise RuntimeError("Cannot reverse this migration. 'Apartament.name_en' and its values cannot be restored.")
