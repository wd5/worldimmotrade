...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TarifRequests.end_date'
        db.alter_column('tarifs_tarifrequests', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'TarifRequests.start_date'
        db.alter_column('tarifs_tarifrequests', 'start_date', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'TarifRequests.end_date'
        raise RuntimeError("Cannot reverse this migration. 'TarifRequests.end_date' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'TarifRequests.start_date'
        raise RuntimeError("Cannot reverse this migration. 'TarifRequests.start_date' and its values cannot be restored.")
