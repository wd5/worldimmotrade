...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_userprofile', (
            ...
            ('is_saler', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('treatment', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ...
            ('post_code', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['world.Country'], null=True, blank=True)),
            ('region', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['world.Region'], null=True, blank=True)),
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['world.City'], null=True, blank=True)),
            ...
            ('personal_info_show', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('receive_mails', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
